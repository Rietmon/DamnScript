...
namespace DamnScript.Runtimes.Natives
{
    ...
    public readonly unsafe struct ScriptValuePtr
    {
        ...
        public ScriptValue.ValueType Type { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => value->type; }

        public bool BoolValue { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => value->boolValue; }
        public byte ByteValue { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => value->byteValue; }
        public sbyte SByteValue { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => value->sbyteValue; }
        public short ShortValue { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => value->shortValue; }
        public ushort UShortValue { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => value->ushortValue; }
        public int IntValue { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => value->intValue; }
