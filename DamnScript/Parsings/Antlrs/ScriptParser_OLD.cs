...
//             
//                 var region = ParseRegion(program.GetChild(i), context);
//                 regions.Add(region);
//             
...
//                     return;
//                 case DamnScriptParser.LogicalOpContext logicalExpression:
//                     AssemblyLogicalExpression(logicalExpression, context);
//                     return;
//             
//                 case DamnScriptParser.NumberContext expression:
//                     AssemblyNumberExpression(expression, context);
//                     break;
//                 case DamnScriptParser.FuncCallContext methodCall:
//                     AssemblyMethodCall(methodCall, context);
//                     return;
//                 case DamnScriptParser.StringContext stringLiteral:
//                     AssemblyStringLiteral(stringLiteral, context);
//                     break;
//                 case DamnScriptParser.MulOpContext operatorContext:
//                     AssemblyMultiplicativeOperator(operatorContext, context);
//                     break;
//                 case DamnScriptParser.VariableContext variableExpression:
...
//             AssemblyMethodCall((DamnScriptParser.FuncCallContext)methodCall, context);
//         }
//
...
//                 if (child is DamnScriptParser.AdditiveExpressionContext or DamnScriptParser.AdditiveExpressionContext)
//                     ParseNode(parent.GetChild(++i), context);
//                 ParseNode(child, context);
//             }
//         }
//     
//         private static void AssemblyLogicalExpression(DamnScriptParser.LogicalOpContext logicalExpression, ScriptParserContext context)
//         {
...
//         }
//
//         private static void AssemblyMethodCall(DamnScriptParser.FuncCallContext methodCall, ScriptParserContext context)
//         {
...
//         }
//
//         private static void AssemblyNumberExpression(DamnScriptParser.NumberContext numberExpression, ScriptParserContext context)
//         {
...
//         }
//
//         private static void AssemblyStringLiteral(DamnScriptParser.StringContext stringLiteral, ScriptParserContext context)
//         {
...
//         }
//         
//         private static void AssemblyVariableExpression(DamnScriptParser.VariableContext variableExpression, ScriptParserContext context)
//         {
...
//         }
//
//         private static void AssemblyMultiplicativeOperator(DamnScriptParser.MulOpContext multiplicativeOperator, ScriptParserContext context)
//         {
//             var operatorText = multiplicativeOperator.GetText();
//             AssemblyOperator(operatorText, context);
//         }
//
//         private static void AssemblyAdditiveOperator(DamnScriptParser.AdditiveExpressionContext additiveOperator, ScriptParserContext context)
//         {
